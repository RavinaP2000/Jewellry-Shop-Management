...
{
    public partial class Employee_Regs : Form
    {
        ...
        private void empregs_savebtn_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Validates())
                {
                    ...
                    cmd = new SqlCommand("insert into emp_regs values(" + eid + ",'" + ename + "','" + eadd + "','" + estate + "','" + edist + "','" + etal + "'," + epin + ",'" + egender + "'," + econtact + ",'" + equal + "'," + eexp + ",'" + eemail + "','" + edate + "'," + esal + ")", con);
                    cmd.ExecuteNonQuery();
                ...
                con.Open();
                cmd = new SqlCommand("select eid from emp_regs", con);
        ...
        private void Employee_Regs_Load(object sender, EventArgs e)
        {
            empregs_statecmb.SelectedItem = empregs_statecmb.SelectedIndex = 0;
            SqlCommand cmd1 = new SqlCommand("select ename from emp_regs", con);
